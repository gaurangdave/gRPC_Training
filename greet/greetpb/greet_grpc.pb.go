...
type GreetServiceClient interface {
	// unary API
	Greet(ctx context.Context, in *GreetReqeust, opts ...grpc.CallOption) (*GreetResponse, error)
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetReqeust, opts ...grpc.CallOption) (*GreetResponse, error) {
...
type GreetServiceServer interface {
	// unary API
	Greet(context.Context, *GreetReqeust) (*GreetResponse, error)
	// server streaming API
...
func (UnimplementedGreetServiceServer) Greet(context.Context, *GreetReqeust) (*GreetResponse, error) {
...
func _GreetService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).Greet(ctx, req.(*GreetReqeust))
	}
