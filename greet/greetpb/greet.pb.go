...
func (x *GreetReqeust) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetReqeust) ProtoMessage() {}

func (x *GreetReqeust) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetReqeust.ProtoReflect.Descriptor instead.
func (*GreetReqeust) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{1}
}

func (x *GreetReqeust) GetGreeting() *Greeting {
	if x != nil {
		return x.Greeting
	}
	return nil
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x65, 0x75, 0x73, 0x74, 0x12, 0x2b, 0x0a, 0x08, 0x67, 0x72,
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x26, 0x0a, 0x10, 0x4c, 0x6f, 0x6e, 0x67,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x31, 0x0a, 0x15, 0x47, 0x72, 0x65,
	...
	0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x65, 0x75, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x67, 0x72,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*GreetReqeust)(nil),           // 1: greet.GreetReqeust
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	0, // 0: greet.GreetReqeust.greeting:type_name -> greet.Greeting
	0, // 1: greet.GreetManyTimesRequest.greeting:type_name -> greet.Greeting
	1, // 2: greet.GreetService.Greet:input_type -> greet.GreetReqeust
